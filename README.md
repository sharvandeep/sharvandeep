...
* Web-based platform that helps students **identify career paths based on assessments**
...
* Platform for tracking **certifications, technical skills, and achievements**
...
* Developed an automated flood barrier system using **Arduino and sensors**
...
* Added documentation in **KLGLUG/Y24OpenSourceEngineering**
